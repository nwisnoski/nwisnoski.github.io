...
\begin{Publication}{Ward, A.S. et al}{Accepted}{Co-located contemporaneous mapping of morphological, hydrological, chemical, and biological conditions in a 5th order mountain stream network, Oregon, USA}{Earth System Science Data}
\end{Publication}

\bigskip
{ In review:}

\begin{Prep}{{\bf Wisnoski, N.I.}, M.E. Muscarella, M.L. Larsen, A.L. Peralta, and J.T. Lennon}{Metabolic insight into bacterial community assembly across ecosystem boundaries}
\end{Prep}

\begin{Prep}{Mueller, E.A., {\bf N.I. Wisnoski}, A.L. Peralta, J.T. Lennon}{Microbial rescue effects: how microbiomes can save hosts from extinction}
\end{Prep}

\begin{Prep}{Voelker, N.M., P.L. Zarnetske, {\bf N.I. Wisnoski}, J.D. Tonkin, C.M. Swan, S. Record, L. Marazzi, N. Lany, T. Lamy, A. Compagnoni, M.C.N. Castorani, R. Andrade, and E.R. Sokol}{Novel insights to be gained from applying metacommunity theory to long-term biodiversity data}
\end{Prep}

\begin{Prep}{Ward, A.S. et al}{Spatial and temporal variation in river corridor exchange across a 5th order mountain stream network}
\end{Prep}

\begin{Prep}{Ward, A.S. et al}{Solute transport and transformation in an intermittent, headwater mountain stream with unsteady discharge}
\end{Prep}
