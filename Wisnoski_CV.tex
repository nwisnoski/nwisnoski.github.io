...
% 
% \begin{rSubsection}{Ph.D. Candidate}{August 2014 -- Present}{Indiana University, Lennon Lab}{Bloomington, IN}
% \item 
% \end{rSubsection}
% 
% \begin{rSubsection}{Field/Lab Technician}{Spring 2014}{University of Texas, Hawkes Lab}{Austin, TX}
% \item 
% \end{rSubsection}
% 
% \begin{rSubsection}{Undergraduate Researcher}{June 2012 -- February 2014}{University of Texas, Leibold Lab}{Austin, TX}
% \item 
% \end{rSubsection}
% 
% \end{rSection}
...
\begin{Publication}{Ward, A.S. et al}{2019}{Co-located contemporaneous mapping of morphological, hydrological, chemical, and biological conditions in a 5th order mountain stream network, Oregon, USA}{Earth System Science Data 11:1567-1581}
\end{Publication}

\begin{Publication}{Ward, A.S. et al}{In press}{Solute transport and transformation in an intermittent, headwater mountain stream with diurnal discharge fluctuations}{Water}
\end{Publication}

\bigskip
{ In review:}

\begin{Prep}{{\bf Wisnoski, N.I.}, M.E. Muscarella, M.L. Larsen, A.L. Peralta, and J.T. Lennon. In review}{Metabolic insight into bacterial community assembly across ecosystem boundaries}
\end{Prep}

\begin{Prep}{Mueller, E.A., {\bf N.I. Wisnoski}, A.L. Peralta, J.T. Lennon. In revision}{Microbial rescue effects: how microbiomes can save hosts from extinction}
\end{Prep}

\begin{Prep}{Voelker, N.M., P.L. Zarnetske, {\bf N.I. Wisnoski}, J.D. Tonkin, C.M. Swan, S. Record, L. Marazzi, N. Lany, T. Lamy, A. Compagnoni, M.C.N. Castorani, R. Andrade, and E.R. Sokol. In revision}{Novel insights to be gained from applying metacommunity theory to long-term biodiversity data}
\end{Prep}

\begin{Prep}{Ward, A.S. et al. In revision}{Spatial and temporal variation in river corridor exchange across a 5th order mountain stream network}
\end{Prep}
...
\begin{Prep}{{\bf Wisnoski, N.I.} and J.T. Lennon}{Habitat-dependent spatial scaling of bacterial community assembly in a dendritic metacommunity}
\end{Prep}

\begin{Prep}{{\bf Wisnoski N.I.} and J.T. Lennon}{Strong negative frequency-dependence stabilizes the rare but metabolically active subset of a bacterioplankton community}
\end{Prep}
...
%Undergraduate Mentees: Luke Pryke, Mollie Carrison\\
%Summer REU Program: Jaylen Beatty, Mary Wallace, SydneyEllen Gooding


{High School STEM Mentor} \hfill Summer 2015 -- Present\\
{\em Jim Holland Summer Scholars Program}
%High School Mentees: Dakayla Calhoun, Samuel Iwu, Ian Schowe
...
Productivity & \LaTeX, markdown, {\tt git}/GitHub \\
\end{tabular}
